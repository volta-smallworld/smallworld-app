...
/** Map raw MCP tool identifiers to user-friendly display names. */
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  terrain_analyze_area: "Analyze Terrain",
  terrain_find_viewpoints: "Find Viewpoints",
  preview_render_pose: "Render Preview",
}
