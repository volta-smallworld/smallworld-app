...
| [0008](./0008-hour-four-preview-architecture.md) | Accepted | Hour Four Preview Architecture | Preview rendering pipeline with Puppeteer-based headless Cesium, enhancement, and artifact storage. |
